...
// Um array com escopo global, que é o escopo do arquivo JS , nesse caso, contendo cinco strings com suas
// principais skills .
...
//string. Exemplo: "Tryber x aqui! Minhas cinco principais habilidades são:
// JavaScript;
// HTML; ... #goTrybe".

const replaceX = (string, word) => string.replace(/x/g, word);
// console.log(replaceX('Tryber x aqui!', 'David'));
...
console.log(returnList(replaceX('Tryber x aqui!', 'David'), skills));
